...
const EXPLICIT_LABELS: Record<string, string> = {
  ...
  'companyTree.starAria': 'Star {code}',
  'companyTree.unstarAria': 'Unstar {code}',
  'companyTree.trustStatusAria': 'Trust status: {status}',
  'companyTree.trustStatus.verified': 'verified',
  ...
  'heatMap.findIndicatorClear': 'Clear indicator search',
  'heatMap.findIndicatorCount': '{count}/{total}',
  'heatMap.findIndicatorCountTitle': 'Indicators matching your search / total available',
  'heatMap.noIndicatorsMatch': 'No indicators match',
  'heatMap.showAllIndicators': 'Show all',
  'heatMap.showAllIndicatorsAriaCount': 'Show all. {count} indicators hidden',
  'heatMap.hideIrrelevantIndicators': 'Hide non-applicable',
  'heatMap.hideIrrelevantIndicatorsAriaCount': 'Hide non-applicable. {count} indicators hidden',
  'heatMap.statusSummaryTitle': 'Counts for the current decision surface: active, scoped operating companies and applicable indicators.',
  'heatMap.showAllIndicatorsCollapsedHint': 'Only indicators relevant to the current activity profile are shown. Applicable indicators with missing data remain visible.',
  'heatMap.showAllIndicatorsExpandedHint': 'The full indicator catalogue is shown; an active indicator search still narrows the table.',
  'heatMap.notApplicableShort': 'N/A',
  'heatMap.noDataShort': 'N/D',
  'heatMap.missingData': 'No data',
  'heatMap.notApplicableActivity': "N/A: does not match this company's activity profile.",
  'heatMap.notApplicableDisabled': 'N/A: disabled for this company by configuration.',
  'heatMap.notApplicableEntityLevel': 'N/A: this holding-level indicator applies only to subgroup rows.',
  'heatMap.notApplicableNoActionHint': 'Informational only. Drill-down and recompute are unavailable.',
  'heatMap.cellAriaWithValue': '{company}, {indicator}: {status}, {value}',
  'heatMap.cellAriaWithoutValue': '{company}, {indicator}: {status}',
  'heatMap.cellAriaMateriality': 'Materiality: {materiality}',
  'heatMap.cellAriaLowConfidence': 'Low data confidence',
  ...
  // Phase 7.G Turn LXXII (Phase 4.3 closure) — approval-requests admin UI labels.
  'approvalRequests.title': 'Approval Requests',
  'approvalRequests.subtitle': 'Review and approve change requests for closed periods or approved plans.',
  'approvalRequests.filterTitle': 'Filter by status',
  'approvalRequests.filterAll': 'All',
  'approvalRequests.status_pending': 'Pending',
  'approvalRequests.status_approved': 'Approved',
  'approvalRequests.status_rejected': 'Rejected',
  'approvalRequests.status_cancelled': 'Cancelled',
  'approvalRequests.listTitle': 'Requests ({count})',
  'approvalRequests.loading': 'Loading…',
  'approvalRequests.empty': 'No requests in this view.',
  'approvalRequests.requestedMeta': 'Requested {when} by {by}',
  'approvalRequests.reviewedMeta': 'Reviewed {when} by {by}',
  'approvalRequests.proposedChangeToggle': 'Proposed change (raw)',
  'approvalRequests.approveButton': 'Approve',
  'approvalRequests.rejectButton': 'Reject',
  'approvalRequests.cancelButton': 'Cancel',
  'approvalRequests.approveAria': 'Approve request {id}',
  'approvalRequests.rejectAria': 'Reject request {id}',
  'approvalRequests.cancelAria': 'Cancel request {id}',
  'approvalRequests.confirmCancel': 'Cancel this request? It cannot be re-opened.',
  ...
  // Phase 7.G CL — onboarding wizard i18n. Test fixtures assert exact
  // strings (e.g. /.xlsx file/, /target company/, "succeeded", "Recompute").
  // Mirror leaf keys here so tests pass against the same canonical English
  // copy that ships in messages/en.json.
  errPickFile: 'Pick an .xlsx file first.',
  errPickCompany: 'Pick a target company.',
  succeeded: 'succeeded',
  failed: 'failed',
  staging: 'staging',
  applying: 'Applying…',
  ...
  applySheets: 'Apply {n} sheet',
  applySheetsPlural: 'Apply {n} sheets',
  perSheetSummary: '{cols} columns · {headers} source headers · confidence {pct}%',
  perAppliedSheet: '{n} lines · {warns} warning(s) · {dropped} rollups dropped · {unallocated} unallocated',
  recomputeStats: 'Recompute: {ok} ok · {unknown} unknown · {failed} failed (of {targets} targets)',
  importedSuccessfully: 'Imported successfully',
  linesInserted: 'budget lines inserted',
  priorDeleted: 'prior deleted',
  sheetsApplied: 'sheets applied',
  indicatorsStaleWarn: '⚠ One or more indicators failed to recompute — Risk Terminal matrix may be stale until you re-run recompute manually.',
  auditStaleWarn: '⚠ Audit row for this import did not persist — compliance trail incomplete. Notify ops to investigate.',
  anotherImport: 'Import another workbook',
  statusOk: 'OK',
  statusError: 'ERROR',
  // Single-sheet wizard
  applyToBudgetLine: 'Apply to BudgetLine',
  appliedToBudgetLine: 'Applied to BudgetLine',
  analyzeWithAi: 'Analyze with AI',
  restart: 'Restart from step 1',
  loading: 'Loading…',
  aiProposal: 'AI proposal',
  indicatorRecompute: 'Indicator recompute',
  inserted: 'Inserted',
  deleted: 'Deleted',
  warnings: 'Warnings',
  rollupsDeduped: 'Rollups deduped',
  stepUpload: '1. Upload',
  stepReview: '2. Review',
  stepApplied: '3. Applied',
  progress: 'Progress',
  colHeader: 'Header',
  colRole: 'Role',
  colConfidence: 'Conf.',
