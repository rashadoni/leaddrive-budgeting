...
- **Next: 9.3** — trade budget derivation from `SalesBudgetLine` (pool + allocation tree). **Gated on customer answers A2/A3** (spend-type inventory, budget %, principal funding split).
