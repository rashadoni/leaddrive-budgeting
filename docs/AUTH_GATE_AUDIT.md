...
- [ ] (G1) rotate the demo admin credential everywhere it is still in use; production rotation is mandatory before client access and remains an owner credential action.
