...
const log = getLogger("api:import:ai-auto-multi:doctor:explain")

const RATE_LIMIT = {
  name: "import-doctor-explain",
  max: 30,
  windowMs: 60 * 60_000,
}
...
export async function POST(request: NextRequest) {
  ...
  try {
    const result = await runImportDoctorExplanation({
    ...
    log.error("import doctor explanation failed", {
