...
// Phase 8 D1 (2026-05-29) — data-model types + presentational subcomponents
// extracted to sibling modules to bring this file under the 1000-LOC line.
import {
  type AuditFinding,
  type CourtCase,
  type ManageAction,
...
export type { EntityComplianceData } from "./compliance-types";
import {
  SeverityChip,
  StatusBadge,
  downloadCsv,
