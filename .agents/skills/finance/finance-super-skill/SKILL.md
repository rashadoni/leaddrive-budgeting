...
A unified reference merging Perplexity Computer's 8 finance/investment skills with Codex's Financial Analyst, Senior Data Engineer, Senior Data Scientist, Senior ML Engineer, and Invoice Organizer skills. Covers the full spectrum from journal entries and month-end close to DCF valuation, ETL pipelines, and ML-powered forecasting.

---

## 0. Gap Analysis: Perplexity Computer vs Codex Finance Skills

| Capability | Perplexity Computer | Codex | Combined Coverage |
|---|---|---|---|
...
- Perplexity skills cover accounting workflows deeply; Codex adds data infrastructure.
- Codex covers ML/engineering; Perplexity adds real-time market data and SEC filings.
...
These capabilities are available only through Perplexity Computer's connected tools and are not available in Codex or other environments.
