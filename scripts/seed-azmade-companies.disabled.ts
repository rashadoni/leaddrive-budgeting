/**
 * Phase 7.E AZMADE saturation — extend AZMADE org with diversified L1
 * sub-groups + 24 L2 op-cos so HeatMap exercises ~30 of 53 indicators
 * with realistic green/amber/red severity spread.
 *
 * Why this exists: AZMADE original seed has 13 companies all in
 * `industrial` / `services` industries → only ~5 indicators light up per
 * company → matrix sparse, Bloomberg-grade "wall of cells" demo punch
 * missing. This script adds 6 new L1 sub-groups (AZ-HOTELS / AZ-AGRO /
 * AZ-IND / AZ-FOOD / AZ-RE / AZ-SVC) ALONGSIDE the existing 5
 * (AAC/ATL/SPARK/ZTP/LLS) — preserving real customer data while adding
 * diversified showcase data for the Friday 2026-05-01 demo.
 *
 * Industries covered by the showcase tree: hospitality / agro_crops /
 * poultry / industrial / pharma / food_processing / beverage /
 * real_estate / logistics / retail / construction / entertainment /
 * education.
 *
 ...
 * Codes are AZ-* prefixed → no collision with existing AAC/ATL/SPARK/ZTP/LLS.
 *
 * Run:
 *   npx tsx scripts/seed-azmade-companies.ts
 *
 * Then trigger recompute:
 *   npx tsx scripts/seed-azmade-companies.ts --recompute
 *
...
const SUB_GROUPS: CompanySeed[] = [
  { code: 'AZ-HOTELS', name: 'Demo Hospitality Group', level: 1, country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 100 },
  { code: 'AZ-AGRO', name: 'Demo Agro Group', level: 1, country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 200 },
  { code: 'AZ-IND', name: 'Demo Industrial Group', level: 1, country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 300 },
  { code: 'AZ-FOOD', name: 'Demo Food & Beverage Group', level: 1, country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 400 },
  { code: 'AZ-RE', name: 'Demo Real Estate Group', level: 1, country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 500 },
  { code: 'AZ-SVC', name: 'Demo Services Group', level: 1, country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 600 },
];

const OP_COMPANIES: CompanySeed[] = [
  // Hospitality (3 hotels — 1 green / 1 amber / 1 red)
  { code: 'AZ-HOTEL-CG', name: 'Caspian Grand Hotel', industry: 'hospitality', level: 2, parentCode: 'AZ-HOTELS', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 110, severity: 'green', settings: { totalRooms: 180 } },
  { code: 'AZ-HOTEL-KB', name: 'Khazar Beach Resort', industry: 'hospitality', level: 2, parentCode: 'AZ-HOTELS', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 120, severity: 'amber', settings: { totalRooms: 120 } },
  { code: 'AZ-HOTEL-SB', name: 'Sheki Boutique Inn', industry: 'hospitality', level: 2, parentCode: 'AZ-HOTELS', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 130, severity: 'red', settings: { totalRooms: 60 } },
  // Agro crops (3 farms)
  { code: 'AZ-AGRO-AW', name: 'Aran Wheat Fields', industry: 'agro_crops', level: 2, parentCode: 'AZ-AGRO', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 210, severity: 'green' },
  { code: 'AZ-AGRO-MP', name: 'Mil Plain Cotton', industry: 'agro_crops', level: 2, parentCode: 'AZ-AGRO', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 220, severity: 'amber' },
  { code: 'AZ-AGRO-KV', name: 'Kur Valley Vegetables', industry: 'agro_crops', level: 2, parentCode: 'AZ-AGRO', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 230, severity: 'red' },
  // Poultry (2)
  { code: 'AZ-POULT-GJ', name: 'Ganja Poultry', industry: 'poultry', level: 2, parentCode: 'AZ-AGRO', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 240, severity: 'green' },
  { code: 'AZ-POULT-AB', name: 'Absheron Broilers', industry: 'poultry', level: 2, parentCode: 'AZ-AGRO', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 250, severity: 'red' },
  // Industrial (3 plants)
  { code: 'AZ-IND-SS', name: 'Sumgait Steel Works', industry: 'industrial', level: 2, parentCode: 'AZ-IND', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 310, severity: 'green' },
  { code: 'AZ-IND-BC', name: 'Baku Cement Plant', industry: 'industrial', level: 2, parentCode: 'AZ-IND', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 320, severity: 'amber' },
  { code: 'AZ-IND-CP', name: 'Caspian Plastics', industry: 'industrial', level: 2, parentCode: 'AZ-IND', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 330, severity: 'red' },
  // Pharma (2)
  { code: 'AZ-PHARM-AP', name: 'Azeri Pharma Labs', industry: 'pharma', level: 2, parentCode: 'AZ-IND', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 340, severity: 'green' },
  { code: 'AZ-PHARM-GX', name: 'Genix Generics', industry: 'pharma', level: 2, parentCode: 'AZ-IND', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 350, severity: 'amber' },
  // Food & Beverage (4)
  { code: 'AZ-FOOD-CD', name: 'Caspian Dairy', industry: 'food_processing', level: 2, parentCode: 'AZ-FOOD', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 410, severity: 'green' },
  { code: 'AZ-FOOD-AC', name: 'Aran Cannery', industry: 'food_processing', level: 2, parentCode: 'AZ-FOOD', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 420, severity: 'amber' },
  { code: 'AZ-BEV-KB', name: 'Khazar Beverages', industry: 'beverage', level: 2, parentCode: 'AZ-FOOD', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 430, severity: 'red' },
  { code: 'AZ-BEV-CS', name: 'Caucasus Spirits', industry: 'beverage', level: 2, parentCode: 'AZ-FOOD', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 440, severity: 'green' },
  // Real Estate (2)
  { code: 'AZ-RE-BT', name: 'Baku Business Towers', industry: 'real_estate', level: 2, parentCode: 'AZ-RE', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 510, severity: 'green', settings: { totalArea: 25000, leasedArea: 23000 } },
  { code: 'AZ-RE-KR', name: 'Khazar Residences', industry: 'real_estate', level: 2, parentCode: 'AZ-RE', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 520, severity: 'amber', settings: { totalArea: 18000, leasedArea: 14400 } },
  // Services umbrella (logistics / retail / construction / entertainment / education)
  { code: 'AZ-LOG-AL', name: 'Atlas Logistics', industry: 'logistics', level: 2, parentCode: 'AZ-SVC', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 610, severity: 'amber' },
  { code: 'AZ-RTL-CR', name: 'Caspian Express Retail', industry: 'retail', level: 2, parentCode: 'AZ-SVC', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 620, severity: 'green' },
  { code: 'AZ-CON-ZC', name: 'Zaman Construction', industry: 'construction', level: 2, parentCode: 'AZ-SVC', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 630, severity: 'red' },
  { code: 'AZ-ENT-CC', name: 'Crescent Cinemas', industry: 'entertainment', level: 2, parentCode: 'AZ-SVC', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 640, severity: 'amber', settings: { capacity: 2400 } },
  { code: 'AZ-EDU-BH', name: 'Baku Higher School', industry: 'education', level: 2, parentCode: 'AZ-SVC', country: 'AZ', baseCurrencyCode: 'AZN', sortOrder: 650, severity: 'green', settings: { targetEnrollment: 1200, teachers: 80 } },
];
